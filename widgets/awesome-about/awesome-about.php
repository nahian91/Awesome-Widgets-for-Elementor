...
class Widget_Awesome_About extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'awea_about_socials_title' => esc_html__('Facebook', 'awesome-widgets-elementor'),
						'awea_about_socials_icon' => ['value' => 'fab fa-facebook', 'library' => 'fa-brands'],
						'awea_about_socials_link' => ['url' => 'https://facebook.com'],
					],
					[
						'awea_about_socials_title' => esc_html__('Twitter', 'awesome-widgets-elementor'),
						'awea_about_socials_icon' => ['value' => 'fab fa-twitter', 'library' => 'fa-brands'],
						'awea_about_socials_link' => ['url' => 'https://twitter.com'],
					],
					[
						'awea_about_socials_title' => esc_html__('Instagram', 'awesome-widgets-elementor'),
						'awea_about_socials_icon' => ['value' => 'fab fa-instagram', 'library' => 'fa-brands'],
						'awea_about_socials_link' => ['url' => 'https://instagram.com'],
					],
					[
						'awea_about_socials_title' => esc_html__('LinkedIn', 'awesome-widgets-elementor'),
						'awea_about_socials_icon' => ['value' => 'fab fa-linkedin', 'library' => 'fa-brands'],
						'awea_about_socials_link' => ['url' => 'https://linkedin.com'],
					],
				],
				'title_field' => '{{{ awea_about_socials_title }}}',
			]
		);
		...
		$this->add_control(
			'awea_about_contents_name_options',
			[
				'label' => esc_html__( 'Name', 'awesome-widgets-elementor' ),
		...
		// Team Title Color
		$this->add_control(
			'awea_about_contents_name_color',
			[
		...
		$this->add_group_control(
			...
			[
				'name' => 'awea_about_contents_name_typography',
		...
		$this->add_control(
			'awea_about_contents_name_spacing',
			[
		...
		$this->add_control(
			'awea_about_contents_desg_options',
			[
				'label' => esc_html__( 'Designation', 'awesome-widgets-elementor' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
		...
		// Team Title Color
		$this->add_control(
			'awea_about_contents_desg_color',
			[
				'label' => esc_html__( 'Color', 'awesome-widgets-elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'awea_about_contents_desg_typography',
		...
		$this->add_control(
			'awea_about_contents_desg_spacing',
			[
				'label' => esc_html__( 'Spacing', 'awesome-widgets-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
		...
		// Start of Tabs
		$this->start_controls_tabs('awea_about_social_tabs');

		// Normal Tab
		$this->start_controls_tab(
			'awea_about_social_tabs_normal',
			[
	...
	protected function render() {
		...
		$awea_about_image_upload = $settings['awea_about_image_upload'];
		$awea_about_image_upload_url = $awea_about_image_upload['url'];
		$awea_about_name = $settings['awea_about_name'];
		$awea_about_designation = $settings['awea_about_designation'];
		$awea_about_socials_list = $settings['awea_about_socials_list'];
        ?>
